...
/**
 * Interfaz para la gestión de empleados administrativos.
 *
 * @author GLuque
 */
public interface AdmEmpleadoDao {
     ...
     * @param coUser Código de usuario
     * @param coEmp Código de empleado
     * @param nuDni Número de DNI
     * @param inAD Indicador de Active Directory
     * @return
     * @throws Exception 
     */
    ...
    /**
     * Actualiza el acceso al sistema de un usuario
     * @param coUser Código de usuario
     * @param coEmp Código de empleado
     * @param nuDni Número de DNI
     * @param inAD Indicador de Active Directory
     ...
     * @return Siguiente código de empleado
     */
