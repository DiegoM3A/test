...
/*import org.springframework.jdbc.core.simple.BeanPropertyRowMapper;*/
...
public class MaestrosDaoImp extends SimpleJdbcDaoBase implements MaestrosDao{
    ...
    @Override
        ...
        try {
            list = this.jdbcTemplate.query(sql.toString(), BeanPropertyRowMapper.newInstance(AnnioBean.class));
    ...
    @Override
        ...
        try {
            list = this.jdbcTemplate.query(sql.toString(), BeanPropertyRowMapper.newInstance(EstadoDocumentoBean.class),
                    new Object[]{nomTabla});
        }catch (EmptyResultDataAccessException e) {
            list = null;
        }catch (Exception e) {
    ...
    @Override
        ...
        try {
            list = this.jdbcTemplate.query(sql.toString(), BeanPropertyRowMapper.newInstance(PrioridadDocumentoBean.class));
        }catch (EmptyResultDataAccessException e) {
            list = null;
        }catch (Exception e) {
            list = null;
