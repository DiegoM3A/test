...
public class DocumentoEmisionAltaController {
    ...
    public @ResponseBody String goUploadEmi(MultipartHttpServletRequest request, HttpServletResponse response) {
        ...
        pNuAnn = ServletUtility.getInstancia().loadRequestParameter((HttpServletRequest) request, "pnuAnn");
        pNuEmi = ServletUtility.getInstancia().loadRequestParameter((HttpServletRequest) request, "pnuEmi");
